...
urlpatterns = [
    ...
    url(r'^$' ,views.show_all_posts,name='home'),
    #url(r'^',include('post.urls'),
    url(r'^myapp', views.source,name='source'),
    url(r'^homepage', views.homepage,name='homepage'),
    url(r'^hw$' ,views.hw,name='hw'),
    #url(r'^post',include('post.urls'),name='post'),
    url(r'^postsignup/',include('post.urls'),name='signup'),
    #url(r'^postuser',include('post.urls'),name='post'),
    ...
    url(r'^edit/(?P<id>\d+)/$',views.editform , name='edit'),
    ...
    url(r'^signup',include('accounts.urls'),name='signup'),
    url(r'^signup$',views.hw)
